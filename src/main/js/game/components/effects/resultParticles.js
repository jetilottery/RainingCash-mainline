define(require => {
  ...
  let bigWinSettings = {
    animatedParticlePrefix: 'BigWin_',
    startFrame: 0,
    endFrame: 23,
    isAnimated: true,
    nonAnimatedImages: [],
  ...
  const defaultSpawnRect = {
    landscape: {x: 206, y: 810, w: 1028, h: 150},
    portrait: {x: 84, y: 1440, w: 642, h: 150}
  };
  ...
  function reconfigure(config, inOrientation){ 
    ...
    newConfig.spawnRect = {};
    newConfig.spawnRect.x = (customConfig.hasOwnProperty('spawnRect') && customConfig.spawnRect[inOrientation].hasOwnProperty('x')) ? customConfig.spawnRect.x : defaultSpawnRect[inOrientation].x;
    newConfig.spawnRect.y = (customConfig.hasOwnProperty('spawnRect') && customConfig.spawnRect[inOrientation].hasOwnProperty('y')) ? customConfig.spawnRect.y : defaultSpawnRect[inOrientation].y;
    newConfig.spawnRect.w = (customConfig.hasOwnProperty('spawnRect') && customConfig.spawnRect[inOrientation].hasOwnProperty('w')) ? customConfig.spawnRect.w : defaultSpawnRect[inOrientation].w;
    newConfig.spawnRect.h = (customConfig.hasOwnProperty('spawnRect') && customConfig.spawnRect[inOrientation].hasOwnProperty('h')) ? customConfig.spawnRect.h : defaultSpawnRect[inOrientation].h;
