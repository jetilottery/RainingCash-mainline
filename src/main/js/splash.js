define(['skbJet/component/resourceLoader/resourceLib', 'skbJet/componentManchester/standardIW/splash/splashLoadController'], function(
  ...
  function onLoadSplashDone() {
    ...
    window.innerWidth > window.innerHeight ?
      childLogo = resLib.splash.loaderImageLandscape :
      childLogo = resLib.splash.loaderImagePortrait;
    loaderContainer.appendChild(childLogo);
  ...
  function updateLogo(){
    loaderContainer.removeChild(childLogo);

     window.innerWidth > window.innerHeight ?
      childLogo = resLib.splash.loaderImageLandscape :
      childLogo = resLib.splash.loaderImagePortrait;
    
    childLogo.className = 'loaderImage';
